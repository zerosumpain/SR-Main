...
try {
 ...
 console.log('PASS: live token deltas, code/command output, durable replay, reconnect error visibility, heartbeat warning, paused status and desktop/phone layout. Synthetic SSE; no model called.');
} finally {
