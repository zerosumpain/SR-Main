...
export const PRESETS: Preset[] = [
  {
    ...
    build: () => ({
      brief: {
        ...
        legalBasis: 'Local multi-agency ISA in place.',
        legalBasisIds: ['art6-1-e', 'art9-2-g', 'dpa-sch1-18', 'ca2004-s11', 'cwsa-2025-sui', 'dpia', 'dsa-isa'],
        interopGoal: 'high',
  ...
  },
  {
    ...
    build: () => ({
      brief: {
        ...
        legalBasis: '',
        legalBasisIds: ['art6-1-c', 'ea1996-s537a', 'dsa-isa'],
        interopGoal: 'high',
      ...
      fields: [
        ...
        custom({ name: 'session', title: 'Session', type: 'enum', description: 'AM or PM session.', required: true, pii: false, specialCategory: false, codelist: 'Session (AM/PM)', codelistId: 'session-ampm' }),
      ],
    }),
  },
  {
    ...
    build: () => ({
      brief: {
        ...
        geographicCoverage: 'England — local authority',
        legalBasis: '',
        legalBasisIds: ['art6-1-e', 'art9-2-h', 'dpa-sch1-18', 'ca2004-s11', 'hsca-2012-s251b', 'dpia', 'dsa-isa'],
        interopGoal: 'high',
      ...
      fields: [
        ...
        custom({ name: 'plan_status', title: 'EHC plan status', type: 'enum', description: 'Stage of the EHC plan (assessment, issued, ceased).', required: true, pii: true, specialCategory: true, codelist: 'EHC plan status', codelistId: 'ehc-plan-status', sourceStandard: 'sen2' }),
  ...
  },
  {
    ...
    build: () => ({
      brief: {
        ...
        legalBasisIds: ['localism-2011-s1'],
        interopGoal: 'high',
