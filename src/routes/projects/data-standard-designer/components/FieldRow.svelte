...
<style>
  .fr { border: 1.5px solid var(--card-border); border-radius: var(--radius-sharp); background: var(--surface-elevated); margin-bottom: 8px; }
  ...
  .fr-grip { background: none; border: none; cursor: pointer; color: var(--text-muted); font-size: var(--fs-label-xs); padding: 2px 4px; }
  .fr.selected .fr-grip { color: var(--accent); }
  .fr-id { display: flex; flex-direction: column; gap: 3px; flex: 1 1 200px; min-width: 160px; }
  .fr-name { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--accent); background: transparent; border: none; border-bottom: 1px dashed var(--card-border); padding: 1px 0; }
  .fr-title { font-size: var(--fs-label); font-weight: 600; color: var(--text-primary); background: transparent; border: none; padding: 1px 0; }
  .fr-name:focus, .fr-title:focus { outline: none; border-bottom: 1px solid var(--accent); }
  .fr-type { font-family: var(--font-mono); font-size: var(--fs-label-xs); padding: 4px 6px; border: 1px solid var(--card-border); border-radius: var(--radius-sharp); background: var(--bg); color: var(--text-secondary); }
  .fr-flags { display: inline-flex; gap: 3px; }
  .flag { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.03em; padding: 3px 5px; border: 1px solid var(--card-border); border-radius: var(--radius-sharp); background: transparent; color: var(--text-ghost); cursor: pointer; }
  ...
  .ic { background: none; border: none; cursor: pointer; color: var(--text-muted); font-size: var(--fs-label-xs); padding: 3px 5px; border-radius: var(--radius-sharp); }
  ...
  .tag { font-family: var(--font-mono); font-size: var(--fs-label-xs); padding: 2px 6px; border-radius: var(--radius-sharp); }
  ...
  .def { font-size: var(--fs-label-xs); color: var(--text-muted); }
  .inspect-hint { font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.05em; color: var(--text-ghost); background: none; border: none; cursor: pointer; padding: 0; }
