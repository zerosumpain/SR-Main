...
<style>
  ...
  .q-chip { font-family: 'JetBrains Mono', monospace; font-size: 10px; letter-spacing: 0.06em; color: var(--accent-ink, #0e5b66); background: #fff; border: 1px solid rgba(14,91,102,0.4); border-radius: var(--radius-pill); padding: 4px 11px; white-space: nowrap; }
  .beats { display: flex; align-items: center; gap: 4px; flex-wrap: wrap; list-style: none; margin: 0; padding: 0; }
  .beat { display: inline-flex; align-items: center; gap: 6px; background: transparent; border: 1px solid transparent; border-radius: var(--radius-round); padding: 4px 9px; cursor: pointer; color: rgba(26,16,8,0.66); font-family: 'DM Sans', sans-serif; font-size: 12px; font-weight: 500; }
  .beat:hover { background: rgba(26,16,8,0.06); color: var(--ink); }
  .b-n { display: grid; place-content: center; width: 17px; height: 17px; border-radius: var(--radius-pill); background: rgba(26,16,8,0.14); color: var(--ink); font-family: 'JetBrains Mono', monospace; font-size: 9.5px; font-weight: 600; }
