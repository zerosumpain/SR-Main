...
<style>
  ...
  :global(.ds-card) { border: 1px solid rgba(28,22,17,0.16); border-radius: var(--radius-sharp); background: rgba(255,255,255,0.45); padding: 14px 16px; min-width: 0; }
  :global(.ds-card h3) { font-family: var(--fs-serif); font-weight: 600; font-size: var(--fs-body); margin: 0 0 6px; color: var(--ink); }
  :global(.ds-kicker) { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.12em; text-transform: uppercase; color: rgba(28,22,17,0.5); }
  :global(.ds-body) { font-size: var(--fs-label); line-height: 1.55; color: rgba(28,22,17,0.74); margin: 6px 0 0; }
