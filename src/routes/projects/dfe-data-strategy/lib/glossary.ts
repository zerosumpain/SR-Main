// glossary.ts — the jargon a DfE data-strategy conversation swims in, defined in a
...
export const GLOSSARY: GlossaryTerm[] = [
  { id: 'data-spine', term: 'Data spine', def: "DfE's emerging backbone for joining records about a child or learner across services — one trusted core record other systems link to." },
  ...
  { id: 'upn', term: 'UPN', def: 'Unique Pupil Number — the identifier schools give pupils, used across DfE school data; imperfectly stable when children move.' },
  ...
  { id: 'giac', term: 'GIAC', def: 'Get Information About Children — the DfE service being built to give practitioners a joined view of a child, sitting on the identifier work.' },
  ...
  { id: 'ees', term: 'EES', def: 'Explore Education Statistics — DfE\'s open statistics platform and API.' },
  ...
  { id: 'ndl', term: 'National Data Library', def: 'The government programme to make public-sector datasets findable and usable across departments and for research — DfE data is expected within it.' },
  ...
  { id: 'wonde', term: 'Attendance feed', def: 'The daily flow of attendance data from school MIS to DfE (statutory since September 2024) — the model for API-first collection.' },
  { id: 'ilr', term: 'ILR', def: 'Individualised Learner Record — the further-education equivalent of the school census.' },
  { id: 'plr', term: 'Learning Records Service', def: 'The DfE service behind the ULN and personal learning records.' },
];
