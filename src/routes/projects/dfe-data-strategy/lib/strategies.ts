...
//   • relevance — how directly it bears on the department's data context (does it complement the department?)
...
export const TIER_META: Record<Tier, { label: string; kicker: string; blurb: string; color: string }> = {
  ...
  borrow: {
    ...
    blurb: 'Strong patterns, assets and methods to lift into the strategy — on the department’s own terms. Useful, not binding.',
    color: '#2f6155',
  },
  watch: {
    label: 'Comply & watch',
    kicker: 'Answer to, but don’t follow',
    blurb: 'You must respond to these, and they set the political weather — but they don’t set the department’s direction. Meet them; don’t be led by them.',
    color: '#b4632e',
  },
  context: {
    label: 'Context only',
...
export const STRATEGIES: StrategyItem[] = [
  // ---------------- SHAPE ----------------
  {
    ...
    whyDfE: 'Mandates the Single Unique Identifier (NHS number) and a safeguarding information-sharing duty — the keystone of the department’s whole data agenda.',
  ...
  },
  {
    ...
    whyDfE: 'The cross-government maturity yardstick. Directly operational: it tells the department where it is weak and where to invest first.',
  ...
  },
  {
    ...
    whyDfE: 'Resets the lawful-basis and access regime the department’s every data flow stands on, and changes the rules for data-driven decisions.',
  ...
  },
  {
    ...
    take: 'The door you already walk through. The research gateway behind safe access to the department data — lean on it.',
    whyDfE: 'The principal statutory gateway the department uses to share de-identified data for research, and a candidate power for wider public-service sharing.',
  ...
  },
  {
    ...
    take: 'The centre is building the shop window. Get the department’s best datasets onto the shelves — AI-ready and linkable.',
    whyDfE: 'DSIT’s flagship for unlocking and linking data for the national missions and AI; the live successor to the National Data Strategy that the department is expected to feed.',
  ...
  },
  {
    ...
    take: 'No quality, no strategy. The department’s admin data is only as useful as it is trustworthy.',
    whyDfE: 'Quality is the precondition for every use — analysis, AI, the identifier. The six dimensions are the floor the department must measure against.',
  ...
  // ---------------- BORROW ----------------
  {
    ...
    kind: 'programme', status: 'The department asset', relevance: 0.88, leverage: 0.62, tier: 'borrow',
    take: 'Crown jewels — handle with care. The richest dataset in government, and the biggest trust risk.',
    whyDfE: 'The department’s own flagship asset and its proven linkage practice (NPD + hospital + mortality data); the model — and the cautionary tale — for safe reuse.',
  ...
  },
  {
    ...
    whyDfE: 'Non-statutory but decisive: it (and the ATRS) is how the department keeps the social licence that one lost dataset can destroy.',
  ...
  },
  {
    ...
    whyDfE: 'The canonical map of what a data function does. The department can lift its governance-centred operating model wholesale.',
  ...
  },
  {
    ...
    whyDfE: 'The one industry pattern that fits the department’s reality: domain ownership + federated governance maps onto a sector of autonomous bodies.',
  ...
  },
  {
    ...
    whyDfE: 'A finer-grained capability assessment than the DMA — useful where the department needs evidence-backed scoring of a specific function.',
  ...
  // ---------------- WATCH ----------------
  {
    ...
    whyDfE: 'High-profile and names the department as a delivery partner, but its data implications are indirect: it raises the stakes on foundations rather than setting them.',
  ...
  },
  {
    ...
    whyDfE: 'Requires the department and its ALBs to identify, document and annually report their data assets — a compliance task that doubles as useful hygiene.',
  ...
  },
  {
    ...
    take: 'Show your working. If the department scores or sorts children by algorithm, publish how.',
    whyDfE: 'Mandatory for central government: any algorithmic tool in departmental decision-making must be recorded and published.',
  ...
  },
  {
    ...
    whyDfE: 'The IDS programme is closing after a RED delivery rating; the durable cross-government sharing route for the department is the retained ONS Secure Research Service.',
  ...
  },
  {
    ...
    whyDfE: 'Valuable once the department is managing sensitive data at scale in cloud — but a control framework, not a strategy driver.',
