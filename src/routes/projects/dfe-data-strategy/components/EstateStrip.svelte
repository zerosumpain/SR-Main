...
<style>
  .es { border: 1px solid rgba(28,22,17,0.12); border-radius: var(--radius-round); background: rgba(255,255,255,0.4); padding: 14px 16px; }
  .es-head { display: flex; align-items: center; gap: 8px; margin-bottom: 12px; }
  .es-dot { width: 8px; height: 8px; border-radius: var(--radius-pill); background: rgba(28,22,17,0.3); }
  .es-dot.live { background: var(--accent); box-shadow: 0 0 0 3px var(--accent-tint-25); }
  ...
  .es-more { margin-left: auto; font-family: 'JetBrains Mono', monospace; font-size: 10px; color: var(--accent-ink); text-decoration: none; border-bottom: 1px dashed currentColor; }
  .es-stats { display: grid; grid-template-columns: repeat(auto-fill, minmax(140px, 1fr)); gap: 8px; }
  .stat { display: flex; flex-direction: column; gap: 1px; border: 1px solid rgba(28,22,17,0.1); border-radius: var(--radius-round); background: rgba(255,255,255,0.5); padding: 9px 11px; text-decoration: none; }
  ...
  .es-pubs a { color: var(--accent-ink); text-decoration: none; }
