...
<style>
  ...
  .am-sugg button { text-align: left; font-size: 12px; color: #2f6155; background: rgba(63,125,110,0.07); border: 1px solid rgba(63,125,110,0.25); border-radius: 7px; padding: 7px 10px; cursor: pointer; }
  .am-sugg button:hover { background: rgba(63,125,110,0.15); }
  ...
  .src { font-family: 'JetBrains Mono', monospace; font-size: 8.5px; color: rgba(28,22,17,0.5); background: rgba(28,22,17,0.05); padding: 1px 5px; border-radius: 3px; }
  .am-form { display: flex; gap: 6px; margin-top: 10px; }
  .am-form input { flex: 1; border: 1px solid rgba(28,22,17,0.25); border-radius: 8px; padding: 9px 11px; font-size: 13px; font-family: 'DM Sans', sans-serif; background: rgba(255,255,255,0.7); color: var(--ink); }
  .am-form button { width: 38px; border: none; border-radius: 8px; background: #3f7d6e; color: #fff; font-size: 15px; cursor: pointer; }
