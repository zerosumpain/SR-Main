...
<style>
  ...
  .rf-item { display: flex; align-items: center; gap: 10px; padding: 8px 10px; border: 1px solid rgba(28,22,17,0.1); border-radius: 7px; background: rgba(255,255,255,0.4); }
  .rf-kind { font-family: 'JetBrains Mono', monospace; font-size: 8px; text-transform: uppercase; letter-spacing: 0.05em; color: #8a2d3a; background: rgba(138,45,58,0.1); padding: 3px 6px; border-radius: 4px; white-space: nowrap; }
  .rf-kind.mat { color: #2f6155; background: rgba(63,125,110,0.1); }
  ...
  .rf-act { margin-left: auto; font-family: 'JetBrains Mono', monospace; font-size: 9px; padding: 4px 8px; border: 1px solid rgba(63,125,110,0.4); color: #2f6155; background: rgba(63,125,110,0.06); border-radius: 5px; cursor: pointer; white-space: nowrap; }
  .rf-act:hover { background: rgba(63,125,110,0.16); }
</style>
