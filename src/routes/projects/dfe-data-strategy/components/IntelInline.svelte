...
<style>
  .ii { margin: 14px 0 20px; border: 1px solid rgba(28, 22, 17, 0.14); border-left: 4px solid rgba(28, 22, 17, 0.3);
    border-radius: var(--radius-sharp); background: rgba(255, 255, 255, 0.45); padding: 12px 15px; }
  ...
  .ii-lab { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.14em; text-transform: uppercase; font-weight: 600; color: #8a2d3a; }
  .ii-sub { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: rgba(28, 22, 17, 0.5); }
  ...
  .new { font-family: var(--font-mono); font-style: normal; font-size: var(--fs-label-xs); letter-spacing: 0.08em; color: #fff; background: #8a2d3a; border-radius: var(--radius-sharp); padding: 1px 6px; flex-shrink: 0; }
  .ii-title { font-family: var(--fs-serif); font-size: var(--fs-nav); font-weight: 600; color: var(--ink); text-decoration: none; line-height: 1.3; }
  .ii-title:hover { color: var(--accent-ink); }
  .ii-meta { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: rgba(28, 22, 17, 0.5); }
  .ii-watch { color: #8a2d3a; }
  .ii-sum { margin: 3px 0 2px; font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28, 22, 17, 0.72); max-width: 90ch; }
  .ii-inf { display: inline-flex; align-items: baseline; gap: 5px; font-size: var(--fs-label-xs); color: var(--ink);
    border: 1px solid color-mix(in srgb, var(--c) 45%, transparent); background: color-mix(in srgb, var(--c) 8%, transparent);
    border-radius: var(--radius-sharp); padding: 2px 7px; margin-top: 3px; }
  .ii-inf i { font-family: var(--font-mono); font-style: normal; font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.04em; color: var(--c); }
  .ii-more { margin-top: 9px; font-family: var(--font-mono); font-size: var(--fs-label-xs); padding: 4px 10px;
    border: 1px solid rgba(28, 22, 17, 0.2); background: rgba(255, 255, 255, 0.55); border-radius: var(--radius-sharp); color: var(--ink); cursor: pointer; }
