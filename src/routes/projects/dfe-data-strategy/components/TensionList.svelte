...
<style>
  ...
  .tl-clear { display: flex; align-items: flex-start; gap: 10px; padding: 12px 14px; border: 1px solid var(--success-border); background: var(--success-bg); border-radius: var(--radius-round); }
  ...
  .card { border: 1px solid color-mix(in srgb, var(--c) 40%, transparent); background: color-mix(in srgb, var(--c) 6%, transparent); border-left: 3px solid var(--c); border-radius: var(--radius-round); padding: 10px 13px; }
  .c-head { display: flex; align-items: center; gap: 8px; margin-bottom: 5px; }
  .c-sev { font-family: 'JetBrains Mono', monospace; font-size: 8px; text-transform: uppercase; letter-spacing: 0.06em; color: #fff; background: var(--c); padding: 2px 6px; border-radius: var(--radius-round); }
  ...
  .trig { font-family: 'JetBrains Mono', monospace; font-size: 9px; background: rgba(28,22,17,0.07); border-radius: var(--radius-round); padding: 2px 6px; color: rgba(28,22,17,0.6); }
  .leg { font-family: 'JetBrains Mono', monospace; font-size: 9px; color: var(--accent-ink); text-decoration: none; border-bottom: 1px dashed currentColor; }
</style>
