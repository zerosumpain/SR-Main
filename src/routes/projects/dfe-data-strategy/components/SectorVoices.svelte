...
<style>
  ...
  .sv-filter button { font-family: 'JetBrains Mono', monospace; font-size: 10px; padding: 4px 10px; border-radius: 6px; cursor: pointer; border: 1px solid rgba(28,22,17,0.2); background: rgba(255,255,255,0.6); color: var(--ink); }
  ...
  .bal { display: flex; align-items: center; justify-content: center; height: 100%; background: var(--bc); color: #fff; border-radius: 3px; font-family: 'JetBrains Mono', monospace; font-size: 9px; min-width: 16px; }
  .cards { display: grid; grid-template-columns: repeat(auto-fill, minmax(290px, 1fr)); gap: 10px; }
  .vc { border: 1px solid rgba(28,22,17,0.12); border-left: 3px solid var(--sc); border-radius: 9px; background: rgba(255,255,255,0.45); padding: 11px 13px; display: flex; flex-direction: column; }
  .v-top { display: flex; align-items: baseline; gap: 8px; margin-bottom: 6px; flex-wrap: wrap; }
  .v-stance { font-family: 'JetBrains Mono', monospace; font-size: 8px; text-transform: uppercase; letter-spacing: 0.04em; color: #fff; padding: 2px 6px; border-radius: 4px; }
  ...
  .v-src { font-family: 'JetBrains Mono', monospace; font-size: 9px; color: #2f6f97; text-decoration: none; border-bottom: 1px dashed currentColor; align-self: flex-start; }
