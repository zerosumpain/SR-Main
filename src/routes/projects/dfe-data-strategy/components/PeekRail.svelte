...
<style>
  .pr { width: 100%; height: 100%; display: flex; flex-direction: column; align-items: center; gap: 8px;
    padding: 14px 8px; background: rgba(63,125,110,0.05); border: none; border-right: 1px solid rgba(63,125,110,0.2); cursor: pointer; }
  .pr:hover { background: rgba(63,125,110,0.12); }
  .pr-lab { font-family: 'JetBrains Mono', monospace; font-size: 9px; text-transform: uppercase; letter-spacing: 0.12em; color: #2f6155; }
  ...
  .pr-tense { font-family: 'JetBrains Mono', monospace; font-size: 8.5px; color: #b1455e; text-align: center; line-height: 1.3; }
  .pr-ok { font-family: 'JetBrains Mono', monospace; font-size: 8.5px; color: #2f7d4f; }
