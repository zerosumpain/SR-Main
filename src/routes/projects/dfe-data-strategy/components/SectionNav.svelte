...
<style>
  ...
  .tab.live { border-width: 1.5px; border-color: rgba(63,125,110,0.6); color: #2f6155; background: rgba(63,125,110,0.06); }
  .tab.live:hover { background: rgba(63,125,110,0.14); border-color: #2f6155; }
  .tab.live.active { background: #2f6155; color: var(--paper, #f1ead6); border-color: #2f6155; }
