...
<style>
  .ad { padding: 4px 2px; }
  .ad-bar { display: flex; height: 10px; border-radius: 5px; overflow: hidden; margin: 2px 0 12px; background: rgba(28,22,17,0.08); }
  .ad-bar .seg { display: block; height: 100%; transition: width 0.18s ease; }
  .row { padding: 5px 4px; border-radius: 6px; }
  .row.hl { background: rgba(154,123,31,0.16); box-shadow: 0 0 0 1px rgba(154,123,31,0.4); animation: flash 1.4s ease; }
  @keyframes flash { 0% { background: rgba(154,123,31,0.4); } 100% { background: rgba(154,123,31,0.12); } }
