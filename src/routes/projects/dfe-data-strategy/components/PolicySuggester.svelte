...
<style>
  ...
  .panel { position: fixed; z-index: 81; top: 0; right: 0; height: 100vh; width: min(440px, 94vw); background: var(--paper, #f1ead6);
    border-left: 1px solid rgba(28,22,17,0.18); box-shadow: -10px 0 36px -18px rgba(0,0,0,0.45); display: flex; flex-direction: column; }
  ...
  .ph-kick { font-family: 'JetBrains Mono', monospace; font-size: 8.5px; text-transform: uppercase; letter-spacing: 0.1em; color: rgba(28,22,17,0.5); }
  .ph-title { margin: 3px 0 0; font-family: 'Fraunces', serif; font-size: 17px; font-weight: 600; color: var(--ink, #1c1611); line-height: 1.2; }
  .ph-x { background: none; border: none; font-size: 15px; color: rgba(28,22,17,0.5); cursor: pointer; }
  .pb-body { flex: 1; min-height: 0; overflow-y: auto; padding: 14px 16px; display: flex; flex-direction: column; gap: 9px; }
  .status, .hint { margin: 0; font-size: 12.5px; line-height: 1.5; color: rgba(28,22,17,0.62); }
  .err { margin: 0; font-size: 13px; color: #b1455e; }
  .retry { align-self: flex-start; font-family: 'JetBrains Mono', monospace; font-size: 11px; padding: 5px 10px; border: 1px solid rgba(28,22,17,0.25); background: rgba(255,255,255,0.6); border-radius: 6px; cursor: pointer; }
  .item { display: flex; align-items: flex-start; gap: 10px; border: 1px solid rgba(28,22,17,0.12); border-radius: 9px; background: rgba(255,255,255,0.5); padding: 10px 12px; }
  .item.added { border-color: rgba(47,125,79,0.4); background: rgba(47,125,79,0.06); }
  .i-text { display: flex; flex-direction: column; gap: 2px; min-width: 0; }
  .i-title { font-family: 'DM Sans', sans-serif; font-size: 12.5px; font-weight: 600; color: var(--ink, #1c1611); }
  .i-stmt { font-size: 12px; line-height: 1.45; color: rgba(28,22,17,0.72); }
  .i-add { flex-shrink: 0; align-self: center; font-family: 'JetBrains Mono', monospace; font-size: 10px; padding: 6px 10px; border-radius: 6px; cursor: pointer; border: 1px solid #2f6155; background: #2f6155; color: #fff; }
  .i-add:disabled { background: transparent; color: #2f7d4f; border-color: rgba(47,125,79,0.4); cursor: default; }
  ...
  .pf-count { font-family: 'JetBrains Mono', monospace; font-size: 10px; color: rgba(28,22,17,0.6); }
  .pf-go { font-family: 'DM Sans', sans-serif; font-size: 13px; font-weight: 600; color: var(--paper, #f1ead6); background: var(--ink, #1c1611); padding: 8px 14px; border-radius: 8px; text-decoration: none; }
</style>
