...
<style>
  ...
  .pc { border: 1px solid rgba(28,22,17,0.12); border-left: 3px solid var(--c); border-radius: 8px; background: rgba(255,255,255,0.45); padding: 9px 11px; }
  ...
  .pc-su i { display: block; height: 4px; width: 34px; border-radius: 2px; background: linear-gradient(90deg, var(--g, #b4632e) calc(var(--n) * 20%), rgba(28,22,17,0.12) 0); }
  .pc-su .urg { --g: #b1455e; }
  ...
  .dem { font-family: 'JetBrains Mono', monospace; font-size: 8.5px; background: rgba(28,22,17,0.06); border-radius: 4px; padding: 2px 5px; color: rgba(28,22,17,0.6); }
