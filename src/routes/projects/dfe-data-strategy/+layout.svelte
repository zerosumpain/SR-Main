...
<style>
  ...
  .tagline { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.16em; text-transform: uppercase; color: rgba(28,22,17,0.42); white-space: nowrap; margin-left: auto; }
  ...
  :global(.pe-next) { display: inline-flex; align-items: center; gap: 6px; margin-top: 6px; font-family: var(--font-body); font-size: var(--fs-label); color: var(--paper); background: var(--ink); padding: 9px 16px; border-radius: var(--radius-sharp); text-decoration: none; border: none; cursor: pointer; }
  :global(.pe-next:hover) { background: #000; }
  :global(.pe-card) { border: 1px solid rgba(28,22,17,0.12); background: rgba(255,255,255,0.45); border-radius: var(--radius-sharp); padding: 16px 18px; }
  ...
  .foot-personal { margin: 0 0 10px; font-size: var(--fs-label); line-height: 1.5; color: var(--ink-soft);
  ...
  .foot-disc { margin: 10px 0 0; font-size: var(--fs-label-xs); line-height: 1.55; color: rgba(28,22,17,0.58); }
