...
<style>
  ...
  .bg { margin: 26px 0 0; border: 1px solid rgba(28,22,17,0.12); border-radius: var(--radius-sharp); background: rgba(255,255,255,0.35); padding: 6px 14px; }
  .bg summary { cursor: pointer; font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.06em; color: var(--ink-soft, rgba(28,22,17,0.6)); padding: 8px 0; }
  .bg-body { display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 12px; padding: 6px 0 12px; }
  .bg-grp h4 { margin: 0 0 5px; font-family: var(--fs-serif); font-size: var(--fs-nav); font-weight: 600; color: var(--ink); }
  .bg-grp ul { margin: 0; padding-left: 16px; }
  .bg-grp li { font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28,22,17,0.7); margin-bottom: 4px; }
