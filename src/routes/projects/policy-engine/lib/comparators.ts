...
export const COUNTRIES: Country[] = [
  {
    code: 'UK', name: 'United Kingdom', flag: 'GB', tier: 'anchor',
  ...
  {
    code: 'SG', name: 'Singapore', flag: 'SG', tier: 'leader',
  ...
  {
    code: 'JP', name: 'Japan', flag: 'JP', tier: 'leader',
  ...
  {
    code: 'EE', name: 'Estonia', flag: 'EE', tier: 'leader',
  ...
  {
    code: 'FR', name: 'France', flag: 'FR', tier: 'peer',
  ...
  {
    code: 'DE', name: 'Germany', flag: 'DE', tier: 'peer',
  ...
  {
    code: 'IT', name: 'Italy', flag: 'IT', tier: 'peer',
  ...
  {
    code: 'IE', name: 'Ireland', flag: 'IE', tier: 'other',
  ...
  {
    code: 'PL', name: 'Poland', flag: 'PL', tier: 'other',
  ...
  {
    code: 'VN', name: 'Vietnam', flag: 'VN', tier: 'other',
