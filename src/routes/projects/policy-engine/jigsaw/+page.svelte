...
<style>
  ...
  /* 1 · the number */
  .hero81 { display: flex; align-items: center; gap: 22px; flex-wrap: wrap; padding: 18px 22px; border-radius: var(--radius-sharp);
    border: 1.5px solid var(--error-border); background: var(--error-bg); max-width: 96ch; }
  .h81-big { font-family: var(--fs-serif); font-weight: 600; font-size: clamp(56px, 9vw, 96px); line-height: 0.9; color: #8a2d3a; }
  .h81-lab { margin: 0; flex: 1 1 320px; font-size: var(--fs-body-sm); line-height: 1.55; color: rgba(28,22,17,0.8); }
  .h81-kicker { margin: 12px 0 0; font-size: var(--fs-label); line-height: 1.6; color: rgba(28,22,17,0.72); max-width: 96ch; }

  /* 1 · precise-framing box */
  .precise-box { margin: 14px 0 0; border: 1px solid rgba(28,22,17,0.18); border-left: 3px solid var(--success); border-radius: var(--radius-sharp);
  ...
  .pb-lab { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.07em; text-transform: uppercase; color: var(--success); font-weight: 700; }
  .pb-txt { margin: 0; font-size: var(--fs-label); line-height: 1.6; color: rgba(28,22,17,0.82); }
  ...
  .prec { border: 1px solid rgba(28,22,17,0.14); border-top: 3px solid var(--accent-ink); border-radius: var(--radius-sharp);
  ...
  .prec-name { font-family: var(--fs-serif); font-weight: 600; font-size: var(--fs-nav); line-height: 1.25; color: var(--ink); }
  .prec-period { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.04em; color: var(--accent-ink); }
  .prec-sum { margin: 0; font-size: var(--fs-label-xs); line-height: 1.55; color: rgba(28,22,17,0.78); }
  .prec-find { margin: 0; font-size: var(--fs-label-xs); line-height: 1.55; color: rgba(28,22,17,0.7); }
  .balance { border: 1.5px solid rgba(28,22,17,0.4); border-radius: var(--radius-sharp); background: rgba(28,22,17,0.045); padding: 13px 16px; max-width: 96ch; margin-bottom: 12px; }
  .bal-head { display: flex; align-items: center; gap: 10px; flex-wrap: wrap; margin-bottom: 6px; }
  .bal-lab { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.06em; text-transform: uppercase; color: var(--ink); font-weight: 700; }
  .balance p { margin: 0 0 8px; font-size: var(--fs-label); line-height: 1.62; color: rgba(28,22,17,0.8); }

  /* illustrative-component wrappers */
  .illus-wrap { margin-top: 22px; padding-top: 16px; border-top: 1px dashed rgba(28,22,17,0.22); }
  .illus-h { margin: 0 0 5px; font-family: var(--fs-serif); font-weight: 600; font-size: 17px; color: var(--ink); }
  .illus-cap { margin: 0 0 13px; font-size: var(--fs-label); line-height: 1.55; color: rgba(28,22,17,0.68); max-width: 92ch; }

  /* 2 · the map */
  .map-scroll { overflow-x: auto; background: rgba(255,255,255,0.4); border: 1px solid rgba(28,22,17,0.1); border-radius: var(--radius-sharp); padding: 8px; }
  ...
  .child-c { fill: #1c1611; }
  .child-t { font-family: var(--fs-serif); font-size: var(--fs-label); font-weight: 600; fill: #f1ead6; }
  .node-t { font-family: var(--font-body); font-size: var(--fs-label-xs); fill: rgba(28,22,17,0.78); }
  ...
  .mk { display: inline-flex; align-items: center; gap: 6px; font-family: var(--font-mono); font-size: var(--fs-label-xs); color: rgba(28,22,17,0.65); }
  ...
  .hcard { margin-top: 14px; border: 1px solid rgba(28,22,17,0.16); border-left: 4px solid var(--hc); border-radius: var(--radius-sharp);
  ...
  .hc-name { font-family: var(--fs-serif); font-weight: 600; font-size: var(--fs-body); color: var(--ink); }
  .hc-ring { font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.05em; color: #fff; padding: 2px 7px; border-radius: var(--radius-sharp); }
  ...
  .hc-k { display: block; font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.08em; color: rgba(28,22,17,0.5); margin-bottom: 3px; }
  .hc-cell.can .hc-k { color: var(--success); } .hc-cell.cant .hc-k { color: #8a2d3a; }
  .hc-cell p { margin: 0; font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28,22,17,0.78); }

  /* the eighteenth holder */
  .family { margin-top: 16px; border: 1.5px solid rgba(28,22,17,0.5); border-radius: var(--radius-sharp); background: rgba(28,22,17,0.045); padding: 13px 16px; max-width: 96ch; }
  .fam-lab { display: block; font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.08em; text-transform: uppercase; color: var(--ink); font-weight: 700; margin-bottom: 6px; }
  .family p { margin: 0; font-size: var(--fs-label); line-height: 1.6; color: rgba(28,22,17,0.78); }

  /* 3 · RACI */
  .raci-scroll { overflow-x: auto; }
  .raci { border-collapse: collapse; width: 100%; min-width: 860px; }
  .raci th { text-align: center; font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.05em;
  ...
  .raci td.job { font-family: var(--fs-serif); font-weight: 600; font-size: var(--fs-label); color: var(--ink); min-width: 190px; }
  .raci td.cell { text-align: center; }
  tr.noA td.job { color: #8a2d3a; }
  .pill { display: inline-flex; align-items: center; justify-content: center; width: 22px; height: 22px; border-radius: var(--radius-sharp);
  ...
  .gap-txt { font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28,22,17,0.62); }
  tr.gaprow.noA .gap-txt { color: #8a2d3a; }
  .raci-key { display: flex; gap: 14px; flex-wrap: wrap; margin-top: 10px; }
  .rk { display: inline-flex; align-items: center; gap: 6px; font-family: var(--font-mono); font-size: var(--fs-label-xs); color: rgba(28,22,17,0.6); }
  .rk i { display: inline-flex; align-items: center; justify-content: center; width: 16px; height: 16px; border-radius: var(--radius-sharp); font-size: var(--fs-label-xs); font-weight: 700; font-style: normal; }
  .rk-noa { background: var(--error-bg); color: #8a2d3a; }

  /* 4 · tissue + graveyard */
  .ti-grp { margin-bottom: 18px; }
  .ti-grp-lab { display: block; font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.12em; text-transform: uppercase;
  ...
  .ti { border: 1px solid rgba(28,22,17,0.13); border-top: 3px solid var(--tc); border-radius: var(--radius-sharp); padding: 12px 14px;
  ...
  .ti-name { font-family: var(--fs-serif); font-weight: 600; font-size: var(--fs-nav); color: var(--ink); }
  .ti-status { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--tc); }
  .ti-what { margin: 0; font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28,22,17,0.74); }
  .ti-frag { margin: 0; font-size: var(--fs-label-xs); line-height: 1.45; font-weight: 600; color: #8a2d3a; }
  .ti-src { margin-top: auto; align-self: flex-start; font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--accent-ink); text-decoration: none; border-bottom: 1px dashed currentColor; }
  .grave { border: 1px dashed rgba(28,22,17,0.4); border-radius: var(--radius-sharp); background: rgba(28,22,17,0.04); padding: 13px 16px; max-width: 96ch; }
  .gr-lab { display: block; font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.08em; text-transform: uppercase; color: rgba(28,22,17,0.65); font-weight: 600; margin-bottom: 6px; }
  .grave p { margin: 0; font-size: var(--fs-label); line-height: 1.6; color: rgba(28,22,17,0.78); }

  /* 5 · gaps */
  .gaps { display: grid; grid-template-columns: repeat(auto-fit, minmax(min(290px, 100%), 1fr)); gap: 10px; }
  .gp { border: 1px dashed var(--error-border); border-radius: var(--radius-sharp); padding: 10px 12px; background: var(--error-bg); }
  .gp-name { font-family: var(--font-mono); font-size: var(--fs-label-xs); font-weight: 600; color: #8a2d3a; text-transform: uppercase; letter-spacing: 0.04em; }
  .gp-det { margin: 5px 0 0; font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28,22,17,0.74); }

  /* citation chips */
  .refrow { display: flex; gap: 6px; flex-wrap: wrap; margin-top: 9px; }
  .refchip { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--accent-ink); text-decoration: none;
    border: 1px solid var(--accent-ink-tint-35); border-radius: var(--radius-sharp); padding: 2px 7px; background: var(--accent-ink-tint-06); }
  ...
  .vo { display: flex; gap: 12px; align-items: flex-start; border: 1px solid var(--success-border); border-radius: var(--radius-sharp); padding: 11px 14px; background: var(--success-bg); }
  ...
  .vo-move { font-family: var(--fs-serif); font-weight: 600; font-size: var(--fs-nav); color: var(--ink); }
  .vo-what { font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28,22,17,0.74); }
  .vo-cost { font-size: var(--fs-label-xs); color: rgba(28,22,17,0.6); }
  .vo-cost b { color: var(--success); }
  .donts { border: 1px solid var(--accent-ink-tint-35); border-left: 3px solid var(--accent-ink); border-radius: var(--radius-sharp);
    background: var(--accent-ink-tint-06); padding: 13px 16px; max-width: 96ch; }
  .do-lab { display: block; font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.1em; text-transform: uppercase; color: var(--accent-ink); font-weight: 600; margin-bottom: 6px; }
  .donts p { margin: 0 0 8px; font-size: var(--fs-label); line-height: 1.6; color: rgba(28,22,17,0.78); }
  .do-link { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--accent-ink); text-decoration: none; border-bottom: 1px dashed currentColor; }
</style>
