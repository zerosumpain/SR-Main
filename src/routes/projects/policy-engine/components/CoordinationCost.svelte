...
<style>
  ...
  .cc-flag-lab { font-family: var(--font-mono); font-size: var(--fs-label-xs); font-weight: 700; letter-spacing: 0.08em;
    color: var(--accent-ink); background: var(--accent-ink-tint-12); border: 1px solid var(--accent-ink-tint-35); border-radius: var(--radius-sharp); padding: 2px 7px; }

  .cc-ctl { display: grid; grid-template-columns: repeat(auto-fit, minmax(230px, 1fr)); gap: 10px;
    padding: 12px 14px; border: 1px solid rgba(28,22,17,0.14); border-radius: var(--radius-sharp); background: rgba(255,255,255,0.42); }
  .ctl { display: flex; align-items: center; gap: 9px; }
  .ctl-lab { font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.05em;
    color: rgba(28,22,17,0.6); flex: 1 1 auto; }
  .ctl input { flex: 1 1 80px; min-width: 80px; accent-color: var(--c); }
  .ctl-val { font-family: var(--fs-serif); font-weight: 600; font-size: 19px; color: var(--ink); min-width: 44px; text-align: right; }
  ...
  .cc-graph { display: flex; flex-direction: column; align-items: center; gap: 6px; background: rgba(255,255,255,0.4);
    border: 1px solid rgba(28,22,17,0.1); border-radius: var(--radius-sharp); padding: 10px 12px; }
  ...
  .gv { font-family: var(--fs-serif); font-weight: 600; font-size: 30px; line-height: 1; color: #8a2d3a; }
  .gl { font-size: var(--fs-label-xs); color: rgba(28,22,17,0.66); }
  .gb { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: rgba(28,22,17,0.45); }
  ...
  .kcard { display: flex; flex-direction: column; gap: 2px; padding: 10px 12px; border: 1px solid rgba(28,22,17,0.14); border-radius: var(--radius-sharp); background: rgba(255,255,255,0.42); }
  .kcard.hi { border-left: 3px solid #9a7b1f; background: rgba(154,123,31,0.06); }
  .kv { font-family: var(--fs-serif); font-weight: 600; font-size: 24px; line-height: 1; color: var(--ink); }
  .kcard.hi .kv { color: #8a6a12; }
  .kl { font-size: var(--fs-label-xs); line-height: 1.3; color: rgba(28,22,17,0.66); }
  .kb { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: rgba(28,22,17,0.45); }
  .cost-note { margin: 0; font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28,22,17,0.6); }

  .cc-anchor { border: 1px solid var(--accent-ink-tint-35); border-left: 3px solid var(--accent-ink); border-radius: var(--radius-sharp); background: var(--accent-ink-tint-06); padding: 11px 14px; }
  .an-lab { display: block; font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.07em; text-transform: uppercase;
    color: var(--accent-ink); font-weight: 600; margin-bottom: 6px; }
  .cc-anchor p { margin: 0 0 8px; font-size: var(--fs-label-xs); line-height: 1.55; color: rgba(28,22,17,0.78); }
  .an-refs { display: flex; gap: 6px; flex-wrap: wrap; }
  .rc { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--accent-ink); text-decoration: none;
    border: 1px solid var(--accent-ink-tint-35); border-radius: var(--radius-sharp); padding: 2px 7px; background: var(--accent-ink-tint-06); }

  .cc-assume { border: 1px solid rgba(28,22,17,0.14); border-radius: var(--radius-sharp); background: rgba(255,255,255,0.35); padding: 11px 14px; }
  .as-lab { display: block; font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.07em; text-transform: uppercase;
  ...
  .cc-assume li { font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28,22,17,0.74); }
