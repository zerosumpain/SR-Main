...
<style>
  .rc { background: rgba(255,255,255,0.4); border: 1px solid rgba(28,22,17,0.12); border-radius: var(--radius-sharp); padding: 8px 10px 6px; }
  .rc-head { display: flex; align-items: baseline; justify-content: space-between; gap: 8px; margin-bottom: 2px; }
  .rc-title { font-family: var(--fs-serif); font-weight: 500; font-size: var(--fs-label); color: var(--ink); }
  .rc-cur { font-family: var(--font-mono); font-size: var(--fs-label-xs); font-weight: 600; }
  svg { display: block; }
  ...
  .xlab2 { font-family: var(--font-mono); font-size: var(--fs-label-xs); fill: rgba(28,22,17,0.4); }
