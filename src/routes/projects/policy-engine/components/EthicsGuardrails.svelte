...
<style>
  ...
  .eth-col { border: 1px solid rgba(28,22,17,0.12); border-radius: 11px; padding: 13px 15px; }
  .eth-col.wrong { background: rgba(177,69,94,0.05); border-color: rgba(177,69,94,0.22); }
  .eth-col.right { background: rgba(47,125,79,0.05); border-color: rgba(47,125,79,0.22); }
  .eth-h { display: flex; align-items: center; gap: 8px; font-family: 'Fraunces', serif; font-weight: 600; font-size: 15px; margin: 0 0 8px; color: var(--ink, #1c1611); }
  .eth-dot { width: 9px; height: 9px; border-radius: 50%; }
  .eth-dot.bad { background: #b1455e; } .eth-dot.good { background: #2f7d4f; }
  .eth-lead { margin: 0 0 8px; font-size: 13px; line-height: 1.5; color: rgba(28,22,17,0.78); }
  .eth-lead b { color: var(--ink, #1c1611); }
  .chart { background: rgba(255,255,255,0.5); border: 1px solid rgba(28,22,17,0.08); border-radius: 9px; padding: 6px 8px; }
  ...
  .eth-note { margin: 9px 0 0; font-size: 12px; line-height: 1.5; color: rgba(28,22,17,0.7); padding-left: 10px; border-left: 2px solid rgba(177,69,94,0.4); }
  ...
  .grd li::before { content: '✓'; position: absolute; left: 0; top: 0; color: #2f7d4f; font-weight: 700; font-size: 12px; }
  .grd-do { font-family: 'DM Sans', sans-serif; font-weight: 600; font-size: 13px; color: var(--ink, #1c1611); }
  .grd-why { font-size: 11.5px; line-height: 1.4; color: rgba(28,22,17,0.66); }
  .eth-bottom { margin: 13px 0 0; padding: 11px 14px; border-radius: 9px; font-size: 13.5px; line-height: 1.55; color: rgba(28,22,17,0.8);
    background: rgba(28,22,17,0.04); border: 1px solid rgba(28,22,17,0.12); }
  .eth-bottom b { color: var(--ink, #1c1611); }
