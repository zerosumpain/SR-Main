...
<style>
  .aid { border: 1px solid rgba(122,90,166,0.3); border-radius: 7px; background: rgba(122,90,166,0.05); padding: 10px 11px; margin-top: 10px; }
  .aid-head { display: flex; align-items: center; gap: 7px; margin-bottom: 5px; }
  .tag { font-family: 'JetBrains Mono', monospace; font-size: 9px; font-weight: 600; letter-spacing: 0.1em; color: #fff; padding: 2px 5px; border-radius: 3px; }
  .title { font-family: 'Fraunces', serif; font-weight: 600; font-size: 13px; color: var(--ink, #1c1611); flex: 1; }
  ...
  .reset:hover { color: var(--ink, #1c1611); }
  ...
  .totals { border-top: 1px solid rgba(122,90,166,0.25); margin-top: 4px; padding-top: 7px; }
  ...
  .t-row b { font-family: 'Fraunces', serif; font-size: 14px; color: var(--ink, #1c1611); }
