...
<style>
  ...
  .sw-grp-lab { flex: 0 0 200px; font-family: var(--font-mono); font-size: var(--fs-label-xs); font-weight: 700; text-transform: uppercase; letter-spacing: 0.06em; }
  .sw-grp-row { display: flex; gap: 7px; flex-wrap: wrap; }
  .sw-chip { display: inline-flex; align-items: center; gap: 7px; border: 1px solid rgba(28,22,17,0.22); border-radius: var(--radius-sharp);
    background: rgba(255,255,255,0.55); padding: 5px 11px; font-family: var(--font-body); font-size: var(--fs-label-xs); color: var(--ink); cursor: pointer;
    transition: background 0.12s, border-color 0.12s; }
  .sw-chip i { width: 8px; height: 8px; border-radius: var(--radius-pill); background: var(--sc); }
  .sw-chip:hover { border-color: var(--sc); }
  .sw-chip.on { background: var(--ink); color: var(--paper); border-color: var(--ink); }
  .sw-cost { font-family: var(--font-mono); font-size: var(--fs-label-xs); opacity: 0.6; }
  @media (max-width: 760px) { .sw-grp-lab { flex-basis: 100%; } }

  /* board */
  .sw-scroll { overflow-x: auto; background: rgba(255,255,255,0.4); border: 1px solid rgba(28,22,17,0.1); border-radius: var(--radius-sharp); padding: 8px; }
  .sw-scroll svg { display: block; width: 100%; min-width: 860px; height: auto; }
  .sw-col-lab { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.08em; text-transform: uppercase; fill: rgba(28,22,17,0.5); }
  ...
  .sp-t { font-family: var(--font-mono); font-size: var(--fs-label-xs); font-weight: 700; letter-spacing: 0.1em; fill: var(--ink); }
  .sp-sub { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.05em; fill: rgba(28,22,17,0.55); }
  ...
  .nd.dim { opacity: 0.55; }
  .nd-t { font-family: var(--font-body); font-size: var(--fs-label-xs); fill: var(--ink); }
  .nd.on .nd-t { font-weight: 700; }

  /* detail */
  .sw-detail { margin-top: 14px; border: 1px solid rgba(28,22,17,0.16); border-left: 4px solid var(--sc); border-radius: var(--radius-sharp);
  ...
  .swd-title { font-family: var(--fs-serif); font-weight: 600; font-size: var(--fs-body); color: var(--ink); }
  .swd-pill { font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.05em; color: #fff; padding: 2px 8px; border-radius: var(--radius-sharp); }
  .swd-via { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: rgba(28,22,17,0.55); border: 1px dashed rgba(28,22,17,0.3); border-radius: var(--radius-sharp); padding: 2px 7px; }
  .swd-move { margin-left: auto; font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--accent-ink); text-decoration: none; border-bottom: 1px dashed currentColor; }
  ...
  .swd-k { display: block; font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.08em; color: rgba(28,22,17,0.5); margin-bottom: 3px; }
  .swd-cell p { margin: 0 0 3px; font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28,22,17,0.78); }
  .swd-cell .g { color: var(--accent-ink); } .swd-cell .gb { color: var(--success); }
</style>
