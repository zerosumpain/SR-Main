...
<style>
  ...
  .d-title { font-family: 'Fraunces', serif; font-weight: 600; font-size: 15px; color: var(--ink); }
  .d-sub { font-family: 'JetBrains Mono', monospace; font-size: 9px; color: rgba(28,22,17,0.5); }
  .d-close { margin-left: auto; background: rgba(255,255,255,0.5); border: 1px solid rgba(28,22,17,0.2); border-radius: var(--radius-round); width: 26px; height: 26px; cursor: pointer; font-size: 16px; line-height: 1; color: var(--ink); flex-shrink: 0; }
  ...
  h3 { font-family: 'Fraunces', serif; font-weight: 600; font-size: 13.5px; margin: 0 0 8px; color: var(--ink); }
  ...
  .bestval { margin-top: 12px; padding: 10px 12px; border: 1px solid var(--success-border); border-radius: var(--radius-round); background: var(--success-bg); display: flex; flex-direction: column; gap: 8px; }
  .bestval.on { border-color: var(--success-border); background: var(--success-bg); }
  .bv-head { display: flex; flex-direction: column; gap: 2px; }
  .bv-title { font-family: 'Fraunces', serif; font-weight: 600; font-size: 13px; color: var(--success); }
  .bv-sub { font-size: 10.5px; line-height: 1.4; color: rgba(28,22,17,0.6); }
  .opt-find { align-self: flex-start; font-family: 'DM Sans', sans-serif; font-size: 11px; padding: 5px 12px; border-radius: var(--radius-round); border: 1px solid var(--success); background: var(--success-bg); color: var(--success); cursor: pointer; }
  .opt-find:hover { background: var(--success-border); }
  .opt-ctl { display: flex; align-items: center; gap: 8px; }
  .oc-lab { font-family: 'JetBrains Mono', monospace; font-size: 9px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--success); }
  ...
  .oc-val { font-family: 'JetBrains Mono', monospace; font-size: 10.5px; font-weight: 600; color: var(--success); }
  .opt-res { display: flex; flex-direction: column; gap: 6px; }
  .opt-note { color: var(--success); font-size: 10.5px; font-family: 'JetBrains Mono', monospace; background: none; border: none; padding: 0; cursor: pointer; text-align: left; line-height: 1.4; }
  .opt-tip { display: flex; flex-direction: column; gap: 3px; background: var(--paper-deep); border: 1px solid rgba(28,22,17,0.2); border-radius: var(--radius-round); padding: 8px 10px; }
  ...
  .tip-row em { font-family: 'JetBrains Mono', monospace; font-size: 9.5px; font-style: normal; color: var(--success); text-align: right; }
  .opt-apply { align-self: flex-start; font-family: 'DM Sans', sans-serif; font-size: 11px; padding: 5px 12px; border-radius: var(--radius-round); border: 1px solid var(--success); background: var(--success); color: #fff; cursor: pointer; }
  ...
  .mini { background: rgba(255,255,255,0.5); border: 1px solid rgba(28,22,17,0.2); border-radius: var(--radius-round); padding: 5px 9px; color: var(--ink); font-family: 'JetBrains Mono', monospace; font-size: 10px; cursor: pointer; }
  ...
  .imp-err { display: block; margin-top: 6px; color: var(--error); font-size: 11px; }
  .base-row { display: flex; align-items: center; justify-content: space-between; gap: 8px; flex-wrap: wrap; margin-top: 8px;
    padding: 6px 9px; border: 1px solid var(--accent-ink-tint-22); border-radius: var(--radius-round); background: var(--accent-ink-tint-06); }
  .base-note { font-family: 'JetBrains Mono', monospace; font-size: 9.5px; color: var(--accent-ink); }
  .base-reset { font-family: 'JetBrains Mono', monospace; font-size: 9.5px; color: var(--accent-ink); background: transparent;
    border: 1px solid var(--accent-ink-tint-35); border-radius: var(--radius-round); padding: 3px 7px; cursor: pointer; }
