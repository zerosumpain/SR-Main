...
<style>
  .aoo { border: 1px solid rgba(28,22,17,0.14); border-radius: var(--radius-sharp); background: rgba(255,255,255,0.35); padding: 9px 11px; margin: 10px 0; }
  .aoo-head { display: flex; align-items: baseline; justify-content: space-between; gap: 8px; margin-bottom: 6px; }
  .aoo-title { font-family: var(--fs-serif); font-weight: 600; font-size: var(--fs-label); color: var(--ink); }
  .aoo-count { font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.06em; color: rgba(28,22,17,0.45); }
  ...
  .ai-org { font-family: var(--fs-serif); font-weight: 600; font-size: var(--fs-label); color: var(--ink); }
  .ai-lean, .ai-strength { font-family: var(--font-mono); font-size: var(--fs-label-xs); font-weight: 600; text-transform: uppercase; letter-spacing: 0.04em; }
  .ai-year { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: rgba(28,22,17,0.4); margin-left: auto; }
  .ai-claim { margin: 2px 0 3px; font-size: var(--fs-label-xs); line-height: 1.45; color: rgba(28,22,17,0.82); }
  .ai-src { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--accent-ink); text-decoration: none; }
