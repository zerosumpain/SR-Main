...
<style>
  ...
  .head h3 { font-family: var(--font-display, 'Archivo Black', sans-serif); font-size: 1.05rem; margin: 0 0 0.35rem; color: var(--ink, #1c1611); }
  ...
  .chip { font-family: var(--font-mono, 'JetBrains Mono', monospace); font-size: 0.66rem; text-transform: uppercase; letter-spacing: 0.03em;
    padding: 0.28rem 0.5rem; border: 1px solid var(--line, rgba(28,22,17,0.16)); border-radius: 3px; color: var(--ink-soft, rgba(28,22,17,0.7)); white-space: nowrap; }
  .chip b { color: var(--ink, #1c1611); font-weight: 700; }
  .chip.ok { border-color: rgba(47,125,79,0.4); }
  ...
  .scroll { overflow-x: auto; border: 1px solid var(--line, rgba(28,22,17,0.14)); border-radius: 4px; background: var(--card-bg, rgba(255,255,255,0.4)); }
  ...
  tbody td { padding: 0.5rem 0.5rem; border-bottom: 1px solid var(--line, rgba(28,22,17,0.08)); text-align: center; vertical-align: middle; color: var(--ink, #1c1611); }
