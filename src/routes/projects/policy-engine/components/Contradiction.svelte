...
<style>
  .cx { border: 1px solid rgba(28,22,17,0.16); border-left: 3px solid #b4455e; border-radius: 8px; background: rgba(255,255,255,0.4); margin: 10px 0; overflow: hidden; }
  ...
  .cx-q { font-family: 'Fraunces', serif; font-weight: 600; font-size: 14px; color: var(--ink, #1c1611); }
  ...
  .camp { background: rgba(28,22,17,0.03); border-radius: 6px; padding: 8px 9px; border-top: 2px solid; }
  .camp.a { border-top-color: #2f6f97; }
  ...
  .camp-claim { margin: 4px 0 5px; font-size: 12px; line-height: 1.45; color: var(--ink, #1c1611); }
  ...
  .model-row.resolve { border-left: 2px solid #2f7d4f; padding-left: 8px; }
  ...
  .j-btn { font-family: 'JetBrains Mono', monospace; font-size: 9.5px; color: #8a2d3a; background: rgba(177,69,94,0.08); border: 1px solid rgba(177,69,94,0.3); border-radius: 4px; padding: 1px 6px; cursor: pointer; }
  .j-btn:hover { background: rgba(177,69,94,0.16); }
</style>
