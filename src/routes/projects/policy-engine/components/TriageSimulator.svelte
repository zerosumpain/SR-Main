...
<style>
  ...
  .w { width: 13px; height: 13px; border-radius: var(--radius-pill); display: inline-block; }
  .w.ft { background: #9a3b2e; }
  .w.ff { background: transparent; border: 2px solid var(--error); width: 9px; height: 9px; }
