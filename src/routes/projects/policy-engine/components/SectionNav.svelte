...
<style>
  ...
  .grp-lab { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.14em; text-transform: uppercase;
  ...
  .tab.memo { border-width: 1.5px; border-color: rgba(138,45,58,0.6); color: #8a2d3a; background: var(--error-bg); }
  .tab.memo:hover { background: var(--error-bg); border-color: #8a2d3a; }
  .tab.memo.active { background: #8a2d3a; color: var(--paper); border-color: #8a2d3a; }
  .tab.themes { border-width: 1.5px; border-color: var(--accent-ink-tint-35); color: var(--accent-ink); background: var(--accent-ink-tint-06); }
  .tab.themes:hover { background: var(--accent-ink-tint-12); border-color: var(--accent-ink); }
  .tab.themes.active { background: var(--accent-ink); color: var(--paper); border-color: var(--accent-ink); }
