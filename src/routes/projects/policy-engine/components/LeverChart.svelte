...
<style>
  ...
  .readout {
    border: 1px solid rgba(28,22,17,0.14); border-left: 3px solid #b4632e; border-radius: var(--radius-sharp);
    background: rgba(255,255,255,0.45); padding: 8px 10px; display: flex; flex-direction: column; gap: 1px;
  }
  .ro-lab { font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.1em; color: rgba(28,22,17,0.5); }
  .ro-val { font-family: var(--fs-serif); font-size: 26px; font-weight: 600; color: var(--ink); line-height: 1.05; }
  .ro-val i { font-style: normal; font-size: var(--fs-label-xs); opacity: 0.55; margin-left: 3px; }
  .ro-delta { font-family: var(--font-mono); font-size: var(--fs-label-xs); font-weight: 600; margin-top: 2px; }
  .lc-levers { border-top: 1px solid rgba(28,22,17,0.1); padding-top: 6px; }
  .lev-lab { font-family: var(--font-mono); font-size: var(--fs-label-xs); text-transform: uppercase; letter-spacing: 0.1em; color: rgba(28,22,17,0.5); display: block; margin-bottom: 2px; }
</style>
