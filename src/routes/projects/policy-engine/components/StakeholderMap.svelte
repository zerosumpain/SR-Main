...
<style>
  ...
  td.fault { background: rgba(177,69,94,0.05); }
  .stage { font-family: 'Fraunces', serif; font-weight: 600; font-size: 13px; color: var(--ink, #1c1611); white-space: nowrap; }
  ...
  .faults li { font-size: 12.5px; line-height: 1.55; color: rgba(28,22,17,0.74); padding-left: 8px; border-left: 2px solid rgba(177,69,94,0.4); }
