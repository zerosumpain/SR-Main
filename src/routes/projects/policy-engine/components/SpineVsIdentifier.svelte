...
<style>
  ...
  .svi-card { position: relative; border: 1px solid rgba(28,22,17,0.12); border-top: 3px solid var(--ac); border-radius: 11px;
    padding: 13px 15px 30px; background: rgba(255,255,255,0.42); }
  .svi-tag { font-family: 'JetBrains Mono', monospace; font-size: 9px; letter-spacing: 0.14em; color: var(--ac); font-weight: 600; }
  .svi-name { font-family: 'Fraunces', serif; font-weight: 600; font-size: 17px; margin: 4px 0 2px; color: var(--ink, #1c1611); }
  .svi-kind { margin: 0 0 9px; font-size: 12px; line-height: 1.4; color: var(--ac); font-weight: 500; }
  .svi-eli { margin: 0; font-size: 14px; line-height: 1.55; color: rgba(28,22,17,0.78); }
  .svi-dl { margin: 0; display: flex; flex-direction: column; gap: 7px; }
  .svi-dl div { display: grid; grid-template-columns: 78px 1fr; gap: 8px; }
  .svi-dl dt { font-family: 'JetBrains Mono', monospace; font-size: 8.5px; text-transform: uppercase; letter-spacing: 0.06em; color: rgba(28,22,17,0.45); padding-top: 2px; }
  .svi-dl dd { margin: 0; font-size: 12.5px; line-height: 1.45; color: rgba(28,22,17,0.8); }
  .svi-status { color: #b1455e !important; font-weight: 500; }
  .svi-src { position: absolute; left: 15px; bottom: 10px; font-family: 'JetBrains Mono', monospace; font-size: 9.5px; color: var(--ac); text-decoration: none; border-bottom: 1px dashed currentColor; }
  .svi-neq { display: flex; align-items: center; justify-content: center; padding: 0 2px; }
  .svi-neq span { font-family: 'Fraunces', serif; font-size: 26px; color: rgba(28,22,17,0.35); font-weight: 600; }
  .svi-foot { margin: 12px 0 0; padding: 9px 13px; border-radius: 8px; font-size: 12.5px; line-height: 1.5; color: rgba(28,22,17,0.74);
    background: rgba(122,90,166,0.07); border: 1px solid rgba(122,90,166,0.2); }
  .svi-foot b { color: var(--ink, #1c1611); }
