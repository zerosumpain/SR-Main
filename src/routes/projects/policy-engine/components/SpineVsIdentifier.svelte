...
<style>
  ...
  .svi-card { position: relative; border: 1px solid rgba(28,22,17,0.12); border-top: 3px solid var(--ac); border-radius: var(--radius-round);
  ...
  .svi-name { font-family: 'Fraunces', serif; font-weight: 600; font-size: 17px; margin: 4px 0 2px; color: var(--ink); }
  ...
  .svi-foot { margin: 12px 0 0; padding: 9px 13px; border-radius: var(--radius-round); font-size: 12.5px; line-height: 1.5; color: rgba(28,22,17,0.74);
