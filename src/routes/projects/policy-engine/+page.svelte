...
<div class="pe-route wide">
  ...
  <section class="story pe-prose cols">
    ...
    {:else}
      <p>
        <b>What this is.</b> A <b>system-dynamics and cohort simulation</b>, calibrated to the Education Policy Institute’s gap estimates,
