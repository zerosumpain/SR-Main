...
export const PARTS: Part[] = [
  ...
  },
  {
    ...
    lede: 'Mail, files, decks, credentials, the house, the body. Every new ability costs context before it has done a single useful thing.',
    tone: 'var(--success)',
    leaves: [
  ...
  },
  {
    ...
    lede: 'Every night it reads its own failures and writes improvements. What it is allowed to install by itself, and what it very much is not.',
    tone: '#8a2d3a',
    leaves: [
