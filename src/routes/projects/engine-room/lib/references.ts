...
export const REFERENCES: Reference[] = [
  ...
  { name: 'OpenStreetMap', url: 'https://www.openstreetmap.org/about', what: 'the volunteer-mapped paths and tiles the outdoor field kit navigates by' },
  { name: 'openrouteservice', url: 'https://openrouteservice.org/', what: 'the router that draws candidate loops over real mapped paths' },
  { name: 'IndexedDB', url: 'https://developer.mozilla.org/en-US/docs/Web/API/IndexedDB_API', what: 'the browser storage the offline map tiles live in' },
  { name: 'Naismith’s rule', url: 'https://en.wikipedia.org/wiki/Naismith%27s_rule', what: 'the climb-to-distance equivalence behind the route difficulty bands' },
  { name: 'Wilson score interval', url: 'https://en.wikipedia.org/wiki/Binomial_proportion_confidence_interval#Wilson_score_interval', what: 'why one helpful serve does not promote a lesson in the build’s memory' },
