...
export const SURFACES: Surface[] = [
  ...
  // ---- III. the machine room ----------------------------------------------
  {
    ...
    features: [
      ...
      { label: 'Generated, not remembered', what: 'The map is assembled from the registry that generates the live routing config, the build-time route inventory and a probe of the running processes. It used to be a hand-typed file, and it quietly missed six applications.', section: 'ground/estate' },
    ],
  ...
  },
  {
    ...
    kicker: 'Owner only',
    open: false,
    line: 'A live map of the machines this runs on and whether they are answering, assembled from what is actually deployed rather than from a file someone maintains. One codebase, several applications, and strong opinions about which host is allowed to do what.',
    features: [
      ...
      { label: 'It says what it could not read', what: 'Each feed reports how many things it found, or declines to answer. A source it cannot reach shows as unread rather than as zero, because zero looks like an answer.', section: 'ground/estate' },
    ],
    leads: ['admin', 'health'],
  },
];
