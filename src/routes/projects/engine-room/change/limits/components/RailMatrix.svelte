...
<style>
  ...
  .d-kind, .d-notemark { font-family: 'JetBrains Mono', monospace; font-size: 9px; letter-spacing: 0.1em;
  ...
  .d-note { font-size: 12.5px; line-height: 1.55; color: rgba(28,22,17,0.72);
