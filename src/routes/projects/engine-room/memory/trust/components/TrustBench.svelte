...
<style>
  ...
  .c-row button { font-family: var(--font-body); font-size: var(--fs-label-xs); color: var(--text-primary);
  ...
  .pip { width: 28px; height: 26px; font-family: var(--font-mono); font-size: var(--fs-label-xs);
    font-weight: 600; color: var(--text-primary); background: rgba(255,255,255,0.65);
    border: 1px solid rgba(28,22,17,0.2); border-radius: var(--radius-sharp); cursor: pointer;
  ...
  .a-say { font-size: var(--fs-label-xs); color: rgba(28,22,17,0.6); margin-left: 4px; }
  ...
  .toggle { font-family: var(--font-body); font-size: var(--fs-label-xs); color: var(--text-primary);
  ...
  .bar { position: relative; display: flex; height: 30px; border-radius: var(--radius-sharp);
  ...
  .seg:first-child { border-radius: var(--radius-sharp) 0 0 var(--radius-sharp); }
  ...
  .band-mark i { position: absolute; left: 3px; top: -2px; font-style: normal;
    font-family: var(--font-mono); font-size: var(--fs-label-xs); color: rgba(28,22,17,0.45); white-space: nowrap; }

  .read { display: flex; align-items: baseline; gap: 10px; flex-wrap: wrap; }
  .s-val { font-family: var(--font-mono); font-size: 30px; font-weight: 600;
  ...
  .s-band { font-family: var(--font-mono); font-size: var(--fs-label-xs); letter-spacing: 0.1em;
  ...
  .s-sum { font-size: var(--fs-label-xs); color: rgba(28,22,17,0.55); margin-left: auto; }
  ...
  .l-lab { font-size: var(--fs-label-xs); color: rgba(28,22,17,0.72); }
  .l-val { margin-left: auto; font-family: var(--font-mono); font-size: var(--fs-label-xs);
    font-weight: 600; color: var(--text-primary); white-space: nowrap; }
  .l-val em { font-style: normal; font-weight: 400; font-size: var(--fs-label-xs); color: rgba(28,22,17,0.4); margin-left: 4px; }
  .ledger li.neg .l-val { color: #8a2d3a; }
  .ledger li.neg.idle .l-val { color: rgba(28,22,17,0.4); font-weight: 400; }

  .says { margin: 0; font-size: var(--fs-label); line-height: 1.6; color: rgba(28,22,17,0.74); max-width: 86ch; }
