...
<style>
  ...
  .facts dd { margin: 0; font-size: var(--fs-label); line-height: 1.5; color: rgba(28,22,17,0.78); max-width: 84ch; }
  ...
  .rules span { font-size: var(--fs-label-xs); line-height: 1.5; color: rgba(28,22,17,0.65); }
