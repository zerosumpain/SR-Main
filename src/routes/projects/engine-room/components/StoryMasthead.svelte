<script lang="ts">
  // StoryMasthead — section header. Copied from data-spine/components/StoryMasthead.svelte.
  ...
  let { kicker, title, thesis, thesisEli5, asks, askLabel = 'What this section answers' }: Props = $props();
