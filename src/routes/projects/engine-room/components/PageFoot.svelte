...
<style>
  ...
  .pf-link { display: flex; flex-direction: column; gap: 2px; text-decoration: none; max-width: 46ch;
    padding: 9px 14px; border: 1px solid rgba(28,22,17,0.18); border-radius: var(--radius-round);
  ...
  .pf-dir { font-family: 'JetBrains Mono', monospace; font-size: 9px; letter-spacing: 0.12em;
    text-transform: uppercase; color: var(--accent-ink); }
  .pf-lab { font-family: 'Fraunces', serif; font-weight: 600; font-size: 15px; color: var(--text-primary); line-height: 1.25; }
</style>
