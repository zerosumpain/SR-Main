...
<style>
  ...
  .kn-err { color: var(--status-error, #c0392b); font-size: var(--fs-nav); }
  .kn-empty, .kn-summary { color: var(--text-muted); font-size: var(--fs-nav); }
  ...
  .kn-title { font-size: var(--fs-label); color: var(--text-primary); overflow: hidden; text-overflow: ellipsis; white-space: nowrap; flex: 1; }
  .kn-type { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--text-ghost); flex-shrink: 0; }
  .kn-score { font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--text-ghost); flex-shrink: 0; }
  .kn-passage { margin: 8px 0 0; font-size: var(--fs-nav); line-height: 1.5; color: var(--text-muted); white-space: pre-wrap; word-break: break-word; }
  .kn-open { display: inline-block; margin-top: 6px; font-family: var(--font-mono); font-size: var(--fs-label-xs); color: var(--accent-ink, var(--accent)); text-decoration: none; }
</style>
