<svelte:head><title>File Store — Admin</title></svelte:head>
<script lang="ts">
...
<PageWrap width="wide">
  <PageHeader
    kicker="File Store"
    title="File Store"
    sub="Files consumed by workflows — the File Store canvas node can read, write, append, delete, or list them. Per-file permissions gate every node operation."
  />
