...
<PageWrap width="wide">
  ...
  <div class="stat-grid">
    <div class="stat-card">
      ...
      <div class="stat-card-meta"><a class="nm-link-btn" href={`/admin/ops/tasks${t}`}>View all →</a></div>
    </div>
    <div class="stat-card">
    ...
    <div class="stat-card">
      ...
      <div class="stat-card-meta"><a class="nm-link-btn" href={`/admin/ops/costs${t}`}>Costs →</a></div>
    </div>
    <div class="stat-card">
      <div class="stat-card-label">Actions Today</div>
      <div class="stat-card-value">{data.todayCosts?.actionCount ?? 0}</div>
      <div class="stat-card-meta"><a class="nm-link-btn" href={`/admin/ops/actions${t}`}>Action log →</a></div>
    </div>
  </div>
  ...
  <div class="agent-grid">
    <section class="nm-sec">
      ...
      {#if activeTasks.length === 0}
        <div class="nm-empty">No active tasks. Send a message in <a class="nm-link-btn" href="/jkai">/jkai chat</a> to spin one up.</div>
      {:else}
        <div class="task-list">
    ...
    <section class="nm-sec">
      ...
      <div class="feed">
        ...
        {:else}
          <div class="nm-empty">No activity yet. Send a message in <a class="nm-link-btn" href="/jkai">/jkai chat</a> to see it here.</div>
        {/each}
      </div>
    </section>
  </div>
