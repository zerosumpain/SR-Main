...
// cover tiles and the readout. COUNT queries and one pulse read, nothing
// else — the same rule `/jkai/intel`'s layout follows. Anything expensive
// belongs to the room that renders it, or a badge would tax every room for a
// number. Since P4a (2026-09-25) that is the think loop and nothing else: the
// places, rules and two dozen jobs it used to count are gone.
