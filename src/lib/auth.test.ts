...
describe('isPublicPath', () => {
  it('allows known public pages and APIs', () => {
    for (const p of ['/', '/projects', '/projects/terminal-descent', '/blog', '/blog/x', '/api/landing/vitals', '/api/space-lander/scores', '/api/blog/images/9/x.png', '/jkai/shared', '/jkai/shared/tok_abc123']) {
