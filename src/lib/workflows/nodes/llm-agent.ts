...
export const llmAgentDef: NodeDefinition = {
  ...
  basicConfig: [
    ...
    },
    {
      ...
      description: 'Supports {{input.field}} templates',
    },
    {
      key: 'userPrompt',
      label: 'User Prompt',
    ...
    },
    {
      ...
      type: 'number',
      description: 'Total token budget (0 = unlimited)',
      advancedOnly: true,
    },
    {
      key: 'timeoutMs',
      label: 'Timeout (ms)',
      type: 'number',
      description: 'Max execution time in ms (0 = disabled)',
      advancedOnly: true,
    },
    {
      key: 'toolOverrides',
      label: 'Tool Overrides (JSON)',
      type: 'code',
      description: 'Override tool names/descriptions: { "nodeId": { "name": "...", "description": "..." } }',
      advancedOnly: true,
    },
  ],
  llmDescription:
