...
register({
  name: 'file_list',
  description:
    'List files in the workflow file store (uploaded via /admin/files). Returns id, name, mimeType, sizeBytes, description, and updatedAt for each. Use file_read to read a specific file by id or name.',
  parameters: {
    type: 'object',
    properties: {
