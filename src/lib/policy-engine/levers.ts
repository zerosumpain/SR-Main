...
export const LEVERS: LeverDef[] = [
  ...
  },
  {
    ...
    evidence: '16–18 funding is ~8% below 2010 in colleges and ~20% below in school sixth forms (IFS), and disadvantage funding largely ends at 16 even though the NEET cliff is at 16–18. EPI proposes a 16–19 premium as the most direct funding fix. No causal estimate exists — modelled via post-16 retention with a wide band.',
  ...
  {
    id: 'post16_skills', group: 'post16', label: 'Post-16 skills & qualifications', unit: '%',
    min: 0, max: 100, step: 5, baseline: 20, policy: 70,
    blurb: 'Skills England, T/V-levels and study-programme quality — the qualification side of the bridge from school to work. (The Youth Guarantee and apprenticeships are modelled as their own levers.)',
    evidence: 'NEET (16–24) is 13.3% and projected to reach 1.25m without reform (Milburn 2026). Qualification reform acts on the destination end — lower attainment ⇒ ~2× NEET risk. Re-scoped 2026-06: the Youth Guarantee and apprenticeship recovery moved to dedicated levers, and this effect band was reduced to avoid double-counting.',
    ...
    confidence: 'assumption', policyRef: 'Post-16 White Paper',
  },
  {
  ...
  {
    id: 'careers_gatsby', group: 'post16', label: 'Careers provision (Gatsby coverage)', unit: '%',
    min: 0, max: 100, step: 5, baseline: 35, policy: 60,
    blurb: 'Share of schools and colleges achieving all 8 Gatsby career-guidance benchmarks (the Careers & Enterprise Company infrastructure).',
  ...
  },
  {
    ...
    evidence: 'The YFF toolkit rates apprenticeships the HIGHEST-IMPACT youth-employment intervention — but with LOW evidence security (largely international studies), so the modelled band is deliberately wide. Under-25 starts fell ~40% post-levy; full SME funding for 16–24s begins April 2026.',
...
export const LEVER_ELI5_NAME: Record<string, string> = {
  ...
  attendance: 'Attendance mentors', post16_skills: 'Better courses for school-leavers', mental_health: 'Youth mental-health support',
  youth_guarantee: 'Guaranteed work or training for young people', careers_gatsby: 'Proper careers advice in every school',
  apprenticeships: 'More apprenticeships for under-25s', post16_premium: 'Extra money for poorer sixth-formers',
