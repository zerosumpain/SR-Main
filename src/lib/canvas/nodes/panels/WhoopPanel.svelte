...
<style>
  ...
  .wh-sec-meta { font-family: var(--font-mono); font-size: 10px; color: var(--text-muted); }
  ...
  .wh-hint { font-size: 11px; color: var(--text-ghost); margin: 0; }
  .wh-hint code { font-size: 11px; color: var(--text-muted); }
