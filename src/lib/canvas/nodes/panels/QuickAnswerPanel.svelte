...
<style>
  ...
  .qa-sec-meta { font-family: var(--font-mono); font-size: 10px; color: var(--text-muted); }
  ...
  .qa-hint { font-size: 11px; color: var(--text-ghost); }
  .qa-hint code { font-size: 11px; color: var(--text-muted); }
