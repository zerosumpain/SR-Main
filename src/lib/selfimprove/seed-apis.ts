...
export const SEEDED_APIS: SeedApiEntry[] = [
  ...
  },
  {
    ...
    description:
      'OpenStreetMap routing engine for sport route planning via route_plan: directions, round trips, isochrones and elevation for running, road cycling, mountain biking and hiking. Returns surface, waytype and steepness breakdowns and can generate circular routes. Free tier: 2,500 requests/day, 40/minute; round-trip and alternative routes are capped at 100 km.',
    capabilities: [
      'route planning',
      'running routes',
      'cycling routes',
